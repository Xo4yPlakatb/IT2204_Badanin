...
define('zapp_user_main', ['dart_sdk'], (function load__zapp_user_main(dart_sdk) {
  ...
  var C = [void 0];
  var I = ["file:///zapp/project/lib/Coffee.dart"];
  ...
  main.main = function main$0() {
    return async.async(dart.void, function* main() {
      let machine = new Coffee.Machine.new(0, 0, 0, 0);
      machine.setResource(100);
      core.print(machine.makingCoffee(25, 10, 10, 10, "Айс-латте"));
    });
  };
  var _coffeeBeans$ = dart.privateName(Coffee, "_coffeeBeans");
  var _milk$ = dart.privateName(Coffee, "_milk");
  var _water$ = dart.privateName(Coffee, "_water");
  var _cash$ = dart.privateName(Coffee, "_cash");
  var _isAvailableRessources = dart.privateName(Coffee, "_isAvailableRessources");
  var _subtractResources = dart.privateName(Coffee, "_subtractResources");
  Coffee.Machine = class Machine extends core.Object {
    static ['_#new#tearOff'](_coffeeBeans, _milk, _water, _cash) {
      return new Coffee.Machine.new(_coffeeBeans, _milk, _water, _cash);
    }
    get coffeeBeans() {
  ...
  (Coffee.Machine.new = function(_coffeeBeans, _milk, _water, _cash) {
    this[_coffeeBeans$] = _coffeeBeans;
    this[_milk$] = _milk;
    this[_water$] = _water;
    this[_cash$] = _cash;
    ;
  }).prototype = Coffee.Machine.prototype;
  dart.addTypeTests(Coffee.Machine);
  dart.addTypeCaches(Coffee.Machine);
  dart.setMethodSignature(Coffee.Machine, () => ({
    __proto__: dart.getMethods(Coffee.Machine.__proto__),
  ...
  dart.setGetterSignature(Coffee.Machine, () => ({
    __proto__: dart.getGetters(Coffee.Machine.__proto__),
    coffeeBeans: core.double,
    milk: core.double,
    water: core.double,
    cash: core.double
  }));
  dart.setSetterSignature(Coffee.Machine, () => ({
    __proto__: dart.getSetters(Coffee.Machine.__proto__),
    coffeeBeans: core.double,
    milk: core.double,
    water: core.double,
    cash: core.double
  }));
  dart.setLibraryUri(Coffee.Machine, I[0]);
  dart.setFieldSignature(Coffee.Machine, () => ({
    __proto__: dart.getFields(Coffee.Machine.__proto__),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/lib/Coffee.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;A